...
class CreateJafungSubkegiatan extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('jafung_subkegiatan', function (Blueprint $table) {
            $table->increments('id');
            $table->string('id_jabatan');
            $table->string('id_judul');
            $table->string('id_subjudul');
            $table->string('id_kegiatan');
            $table->string('id_subkegiatan')->nullable();
    ...
    {
        Schema::dropIfExists('jafung_subkegiatan');
    }
}
