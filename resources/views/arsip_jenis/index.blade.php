...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Arsip Jenis</li>
</ul>
@endsection
...
@section('content')
    <div class="container">
      ...
      <div class="card" id="app_vue">
        <div class="body">
          <a href="#" role="button" v-on:click="addData" class="btn btn-primary" data-toggle="modal" data-target="#form_modal"><i class="fa fa-plus-circle"></i> <span>Tambah Arsip Jenis</span></a>
          <br/><br/>
          ...
          <div class="row m-b-15">
            <div class="col-md-4">
              ...
              <div class="input-group">
                <input type="text" class="form-control" v-model="keyword" @keyup.enter="setDatas(1)" placeholder="Cari title atau deskripsi...">
    ...
    methods: {
        ...
        updateData: function (event) {
            ...
            if (event) {
                ...
                self.form_title = target.getAttribute('data-title');
                self.form_deskripsi = target.getAttribute('data-deskripsi');
                self.form_masa_retensi_tahun = target.getAttribute('data-masa-retensi-tahun');
            }
        },
        saveData: function () {
            var self = this;
            
            if (!self.form_title || self.form_title.trim() === '') {
                alert('Title harus diisi');
                return;
            }
            if (!self.form_deskripsi || self.form_deskripsi.trim() === '') {
                alert('Deskripsi harus diisi');
                return;
            }
            if (!self.form_masa_retensi_tahun || self.form_masa_retensi_tahun === '') {
                alert('Masa Retensi Tahun harus diisi');
                return;
            }
            if (isNaN(self.form_masa_retensi_tahun)) {
                alert('Masa Retensi Tahun harus berupa angka');
                return;
            }
            ...
            $.ajax({
                ...
                data:{
                    ...
                    form_deskripsi: self.form_deskripsi,
                    form_masa_retensi_tahun: self.form_masa_retensi_tahun
                },
            }).done(function (data) {
                if (data.success == '1') {
