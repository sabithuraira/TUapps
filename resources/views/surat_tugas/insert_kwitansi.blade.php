                        ...
                        <tbody>
                            <tr v-for="(data, index) in rincian" :key="data.id">
                                <td>
                                    ...
                                    <a href="#" role="button" v-on:click="updateBiaya" data-toggle="modal" 
                                    ...
                                    <td>@{{ data.is_rill }}<input type="hidden" :name="'u_is_rill'+data.id" v-model="data.is_rill"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
