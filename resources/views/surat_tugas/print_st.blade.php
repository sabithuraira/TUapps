...
=======
        ...
        <tr>
            ...
            <td width="3%" valign="top">:</td>
            <td width="47%">
                @if (date('n', strtotime($model_rincian->tanggal_mulai))==date('n',
                strtotime($model_rincian->tanggal_selesai)))
                @if(date('Y-m-d', strtotime($model_rincian->tanggal_mulai))==date('Y-m-d',
                strtotime($model_rincian->tanggal_selesai)))
