<div class="modal fade" id="form_rincian" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <b class="title" id="defaultModalLabel">Rincian Surat Tugas</b>
            </div>
                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        <div class="form-group">Pegawai:
                            <div class="form-line">
                                <select class="form-control" v-model="cur_rincian.nip">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">{{ $model_rincian->attributes()['pejabat_ttd_nip'] }}
                            <div class="form-line">
                                <select class="form-control" v-model="cur_rincian.pejabat_ttd_nip">
                ...
                <div class="row clearfix">
                        ...
                        <div class="form-group">{{ $model_rincian->attributes()['tanggal_mulai'] }}
                            <div class="form-line">
                                <div class="input-group">
                                    <input type="text" class="form-control datepicker form-control-sm" v-model="cur_rincian.tanggal_mulai" id="rincian_tanggal_mulai">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">{{ $model_rincian->attributes()['tanggal_selesai'] }}
                            <div class="form-line">
                                <div class="input-group">
                                    <input type="text" class="form-control datepicker form-control-sm" v-model="cur_rincian.tanggal_selesai" id="rincian_tanggal_selesai">
                                    <div class="input-group-append">                                            
                                        <button class="btn btn-outline-secondary" type="button"><i class="fa fa-calendar"></i></button>
                                    </div>
                                </div>
