<b>Daftar Peserta</b> -
&nbsp <a href="#" data-toggle="modal" data-target="#form_pelatihan" v-on:click="setKategoriPeserta(1)">Tambah Peserta Organik &nbsp &nbsp<i class="icon-plus text-info"></i></a>
&nbsp <a href="#" data-toggle="modal" data-target="#form_pelatihan_mitra" v-on:click="setKategoriPeserta(1)">Tambah Peserta Mitra &nbsp &nbsp<i class="icon-plus text-info"></i></a>
            ...
            <tr v-for="(data, index) in rincian_peserta" :key="data.id">
                <td>
                    ...
                    <template v-if="!is_delete(data.id)">
                        <a :data-id="data.id" v-on:click="delDataTemp(index,1)"><i class="fa fa-trash text-danger"></i>&nbsp </a>
                    </template>
                    @{{ index+1 }}
                </td>
                <td>
                    ...
                    <input type="hidden" :name="'peserta_nip'+data.id" v-model="data.nip">
                    <input type="hidden" :name="'peserta_nama'+data.id" v-model="data.nama">
                    <input type="hidden" :name="'peserta_gol'+data.id" v-model="data.gol">
                    <input type="hidden" :name="'peserta_jabatan'+data.id" v-model="data.jabatan">
                    <input type="hidden" :name="'peserta_jabatan_pelatihan'+data.id" v-model="data.jabatan_pelatihan">
                    <input type="hidden" :name="'peserta_asal_daerah'+data.id" v-model="data.asal_daerah">
                    <input type="hidden" :name="'peserta_unit_kerja'+data.id" v-model="data.unit_kerja">
                    <input type="hidden" :name="'peserta_jenis_peserta'+data.id" v-model="data.jenis_peserta">
                    <input type="hidden" :name="'peserta_tingkat_biaya'+data.id" v-model="data.tingkat_biaya">
                    <input type="hidden" :name="'peserta_kendaraan'+data.id" v-model="data.kendaraan">
                </td>
