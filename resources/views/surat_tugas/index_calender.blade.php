...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Kalender Surat Tugas</li>
</ul>
@endsection
        ...
        <div class="body">
            <div class="mailbox-controls">
                <div>
                    ...
                    <a href="{{action('SuratTugasController@create')}}" class="'btn btn-success btn-sm"><i class='fa fa-plus'></i> Tambah Jadwal Tugas</a>
                </div>
            </div>
            <br/>
            <div class="mailbox-controls">
                <b>Kalender Surat Tugas - </b>
