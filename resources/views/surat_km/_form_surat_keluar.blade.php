<div class="row clearfix">
    <div class="col-md-12 left">
        <div class="form-group">
            ...
            <input type="text" class="form-control {{($errors->first('perihal') ? ' parsley-error' : '')}}" name="perihal2" v-model="form.perihal">
...
<div class="row clearfix">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group date" id="date_id" data-date-autoclose="true" data-provide="datepicker">
                <input type="text" class="datepicker form-control {{($errors->first('tanggal') ? ' parsley-error' : '')}}" name="tanggal2" id="tanggal" v-model="form.tanggal">
    ...
    <div class="col-md-6 left">
        <div class="form-group">
            ...
            <select class="form-control" v-model="form.tingkat_keamanan" name="tingkat_keamanan2">
...
<div class="row clearfix">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nomor_urut2" v-model="form.nomor_urut">
    ...
    <div class="col-md-4 left">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="kode_unit_kerja2" v-model="form.kode_unit_kerja">
    ...
    <div class="col-md-4 left">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="klasifikasi_arsip2" v-model="form.klasifikasi_arsip">
...
<div class="row clearfix">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="dibuat_di2" v-model="form_surat_keluar.dibuat_di">
        </div>
    </div>
    ...
    <div class="col-md-6 left">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="lampiran2" v-model="form_surat_keluar.lampiran">
        </div>
    </div>
</div>
...
<div class="row clearfix">
    <div class="col-md-6">
        <div class="form-group">
            Nama:<br/>
            <input type="text" class="form-control" name="kepada2"  v-model="form_surat_keluar.kepada">
        </div>
    </div>
    ...
    <div class="col-md-6 left">
        <div class="form-group">
            Tempat:<br/>
            <input type="text" class="form-control" name="kepada_di2"  v-model="form_surat_keluar.kepada_di">
        </div>
    </div>
</div>
...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea id="isi2" class="summernote form-control" name="isi2" rows="10"></textarea>
        </div>
    </div>
</div>
...
<div class="row clearfix">
    <div class="col-md-6">
        <div class="form-group">
            Jabatan:<br/>
            <input type="text" class="form-control" name="ditetapkan_oleh2" v-model="form.ditetapkan_oleh">
        </div>
    </div>
    ...
    <div class="col-md-6 left">
        <div class="form-group">
            Nama:<br/>
            <input type="text" class="form-control" name="ditetapkan_nama2" v-model="form.ditetapkan_nama">
        </div>
    </div>
</div>