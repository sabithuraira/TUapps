            ...
            @else
                <thead>
                    <tr>
                        ...
                        <th>{{ $memorandum[0]->attributes()['nomor_petunjuk'] }}</th>
                        <th>{{ $memorandum[0]->attributes()['alamat'] }}</th>
                        <th>{{ $memorandum[0]->attributes()['tanggal'] }}</th>
                        <th>{{ $memorandum[0]->attributes()['perihal'] }}</th>
