<div class="row clearfix">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nomor_urut7" v-model="form.nomor_urut">
    ...
    <div class="col-md-6 left">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="kode_unit_kerja7" v-model="form.kode_unit_kerja">
...
<div class="row clearfix">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="klasifikasi_arsip7" v-model="form.klasifikasi_arsip">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group date" id="date_id" data-date-autoclose="true" data-provide="datepicker">
                <input type="text" class="form-control {{($errors->first('tanggal') ? ' parsley-error' : '')}}" name="tanggal7" id="tanggal" v-model="form.tanggal">
    ...
    <div class="col-md-4 left">
        <div class="form-group">
            ...
            <select class="form-control" name="tingkat_keamanan7" v-model="form.tingkat_keamanan">
...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea id="isi7" class="summernote form-control" name="isi7" rows="10"></textarea>
        </div>
    </div>
</div>
...
<div class="row clearfix">
    <div class="col-md-6">
        <div class="form-group">
            Tempat:<br/>
            <input type="text" class="form-control" name="ditetapkan_di7" v-model="form.ditetapkan_di">
        </div>
    </div>
    ...
    <div class="col-md-6 left">
        <div class="form-group">
            Tanggal:<br/>
            <div class="input-group date" id="date_id" data-date-autoclose="true" data-provide="datepicker">
                <input type="text" class="form-control" name="ditetapkan_tanggal7" id="ditetapkan_tanggal">
                <div class="input-group-append">                                            
                    <button class="btn btn-outline-secondary" type="button"><i class="fa fa-calendar"></i></button>
                </div>
            </div>
...
<div class="row clearfix">
    <div class="col-md-6">
        <div class="form-group">
            Nama:<br/>
            <input type="text" class="form-control" name="ditetapkan_nama7" v-model="form.ditetapkan_nama">
        </div>
    </div>
    ...
    <div class="col-md-6 left">
        <div class="form-group">
            Jabatan:<br/>
            <input type="text" class="form-control" name="ditetapkan_oleh7" v-model="form.ditetapkan_oleh">
        </div>
    </div>
</div>