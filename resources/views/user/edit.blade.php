                ...
                <div class="body">
                    <form method="post" action="{{ action('UserController@update', $id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Nama:</label>
                            <input type="text" class="form-control {{ $errors->first('name') ? ' parsley-error' : '' }}"
                                disabled name="name" value="{{ old('name', $model->name) }}">
                        ...
                        <div class="form-group">
                            <label>NIP:</label>
                            <input type="text"
                                class="form-control {{ $errors->first('nip_baru') ? ' parsley-error' : '' }}" disabled
                                name="nip_baru" value="{{ old('nip_baru', $model->nip_baru) }}">
                        ...
                        <div class="form-group">
                            <label>Jabatan:</label>
                            <input type="text"
                                class="form-control {{ $errors->first('nmjab') ? ' parsley-error' : '' }}" disabled
                                name="nmjab" value="{{ old('nmjab', $model->nmjab) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                class="form-control {{ $errors->first('nmwil') ? ' parsley-error' : '' }}" disabled
                                name="nmwil" value="{{ old('nmwil', $model->nmwil) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select
                                class="form-control  form-control-sm  {{ $errors->first('pimpinan_id') ? ' parsley-error' : '' }}"
                                name="pimpinan_id">
                                @foreach ($list_pegawai as $value)
                                    <option value="{{ $value->id }}"
                                        @if ($value->id == old('pimpinan_id', $model->pimpinan_id)) selected="selected" @endif>{{ $value->nip_baru }}
                                        - {{ $value->name }}</option>
                                @endforeach
                            </select>
