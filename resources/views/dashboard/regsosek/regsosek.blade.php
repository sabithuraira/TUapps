    ...
    <div class="body profilepage_2 blog-page">
        ...
        <div>
            <ul class="nav nav-tabs">
                <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#c2_table">Table</a></li>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#c2_grafik">Grafik</a></li>
            </ul>

            <div class="tab-content">
                @include('dashboard.regsosek_table')
            </div>
        </div>
    </div>
</div>
