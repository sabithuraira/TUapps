...
<div class="modal" id="modal_estimasi" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <b class="title" id="defaultModalLabel">@{{ form_transaksi.rincian_label }}</b>
                <template v-if="form_transaksi.rincian_pj==id_user">
                    <a href="#" v-on:click="setTransaksiDetail" data-id="" 
                        data-label="" data-ket_estimasi_="" 
                        data-total_estimasi="" data-ket_realisasi="" 
                        data-total_realisasi=""
                        data-toggle="modal" data-target="#modal_form_estimasi"> <i class="fa fa-plus-square"></i> Tambah Estimasi</a>
                </template>
            </div>
                            ...
                            <td>
                                <template v-if="form_transaksi.rincian_pj==id_user">
                                    <a href="#" v-on:click="setTransaksiDetail" :data-id="data.id" 
                                        ...
                                        data-toggle="modal" data-target="#modal_form_estimasi"> <i class="fa fa-pencil-square-o"></i></a>
                                </template>
                            </td>
                        </tr>
                    </tbody>
