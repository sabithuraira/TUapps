    ...
    <div class="col-lg-8 col-md-12 left-box">
        <div class="card">
            ...
            <div class="header text-right">
                <a href="{{action('LogBookController@print', $id)}}" class="btn btn-info"><i class="fa fa-print"></i></a>
                <a href="{{action('LogBookController@edit', $id)}}" class="btn btn-warning"><i class="icon-pencil"></i></a>
            </div>
