...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">Kartu Kendali Kuantitas</li>
</ul>
@endsection
    ...
    <div class="container">
      ...
      <div class="card" id="app_vue">
        <div class="body">
          ...
          <section class="datas">
            @include('opname_persediaan.kartu_kendali_list_q')
          </section>
      </div>
...
<script>
  var vm = new Vue({  
      ...
      data:  {
        ...
        pathname : window.location.pathname.replace("/kartu_kendali_q", ""),
      },
      watch: {
          month: function (val) {
              this.setDatas();
