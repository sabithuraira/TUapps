...
<div class="form-group">
    <label>{{ $model->attributes()['angka_kredit'] }}:</label>
    <input type="text" class="form-control {{($errors->first('angka_kredit') ? ' parsley-error' : '')}}" name="angka_kredit" value="{{ old('angka_kredit', $model->angka_kredit) }}">
