...
class CkpController extends Controller
{
    ...
    public function pemantau_ckp(Request $request)
    {
        ...
        return view('ckp.pemantau_ckp', compact(
            'model',
            'idnya',
            'ckp',
            'month',
    ...
    public function rekap_ckp(Request $request)
    {
        ...
        return view('ckp.rekap_ckp', compact(
            'month',
            'year',
            'unit_kerja'
        ));
    ...
    public function create()
    {
        ...
        return view('ckp.create', compact(
            'month',
            'year',
            'model',
            'list_pegawai'
    ...
    public function print(Request $request)
    {
        ...
        $pdf = PDF::loadView('ckp.print', compact(
            'month',
            'year',
            'type',
            'model',
